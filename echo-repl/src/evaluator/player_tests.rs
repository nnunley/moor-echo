...
mod player_registry_tests {
    ...
    fn test_player_creation_and_registry() {
        ...
        assert_eq!(player1.properties.get("username").unwrap(), &crate::storage::PropertyValue::String("alice".to_string()));
        assert_eq!(player1.properties.get("display_name").unwrap(), &crate::storage::PropertyValue::String("alice".to_string()));
    ...
    fn test_player_username_change() {
        ...
        // Change username
        evaluator.change_player_username(player_id, "charles").unwrap();
        ...
        assert_eq!(player.properties.get("username").unwrap(), &crate::storage::PropertyValue::String("charles".to_string()));
    }
